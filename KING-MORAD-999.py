...
def ✮⃝ 𝙈𝙊𝙍𝗔𝗗𝄟⃝():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    ✮⃝ 𝙈𝙊𝙍𝗔𝗗𝄟⃝ = input(f'\033[1;32m ✮⃝ 𝙈𝙊𝙍𝗔𝗗 ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ𝄟⃝\033[1;36m ')
    if ✮⃝ 𝙈𝙊𝙍𝗔𝗗𝄟⃝ in ["1","A"]:
        ✮⃝ 𝙈𝙊𝙍𝗔𝗗𝄟⃝s()
    if ✮⃝ 𝙈𝙊𝙍𝗔𝗗𝄟⃝ in ["2","B"]:
        os.system('xdg-open https://facebook.com/groups/311280858429214/')
...
def ✮⃝ 𝙈𝙊𝙍𝗔𝗗𝄟⃝m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92m✮⃝ 𝙈𝙊𝙍𝗔𝗗𝄟⃝\03[1;91m]🤭[\033[1;92m%s\033[1;91m]😜[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
